...
$tPTbl          = 'fixed_assets_type';
$tpID           = 'id';
$tpTitle        = 'title';
$pageTitle      = 'Fixed Assets Type';
$titleFieldName = 'Title';
if(isset($_GET['add'])){
    if(!$aStatus){$general->redirect($pUrl,146,'add fixed assets type');}
...
elseif(isset($_GET['edit'])){
    ...
    $s = $db->get_rowData($tPTbl,$tpID,$edit);
...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box border-box">
            ...
            $categorys=$db->selectAll($tPTbl,'order by '.$tpTitle.' asc'); 
            ?>
