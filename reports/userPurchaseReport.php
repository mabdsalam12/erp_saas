            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">   
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="javascript:void()" class="btn btn-success" onclick="userPurchaseReport()">Search</a>
                        <script type="text/javascript">
                            function userPurchaseReport(){
                                ...
                                $.ajax({
                                    type:'post',
                                    url:ajUrl,
                                    data:{userPurchaseReport:1,dRange:dRange,rType:rType,supID:supID,category:category,subCategory:subCategory,pID:pID,uID:uID},
