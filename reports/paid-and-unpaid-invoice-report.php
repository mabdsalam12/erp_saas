                ...
                <div class="col-sm-12 col-lg-12">   
                    ...
                    <?php
                        ...
                        $general->inputBoxSelectForReport([
                            ['id'=>PAY_TYPE_CASH,'name'=>'Cash'],
                            ['id'=>PAY_TYPE_CREDIT,'name'=>'Credit'],
                            ['id'=>PAY_TYPE_CASH_ON_DELIVERY,'name'=>'Cash On Delivery'],
                        ],'Pay type','pay_type','id','name');
                        $general->inputBoxSelectForReport([
                            ['id'=>2,'name'=>'Paid'],
                            ['id'=>3,'name'=>'Unpaid'],
                        ],'Paid/unpaid','paid_type','id','name');
                    ?>
                    <div class="col-md-2">
                        <h5 class="box-title">Search</h5>
                        <button class="btn btn-success" onclick="paid_and_unpaid_invoice_report()">Search</button>
                        <script type="text/javascript">
                            ...
                            $(document).ready(function(){
                                const report_data = JSON.parse(localStorage.getItem('paid_and_unpaid_invoice_report'));
                                ...
                                paid_and_unpaid_invoice_report();
                            });
                        </script>
                    </div>
                </div>
