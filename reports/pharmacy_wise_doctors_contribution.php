            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">   
                    ...
                    <div class="col-md-2">
                        ...
                        <button class="btn btn-success" onclick="pharmacy_wise_doctors_contribution()">Search</button>
                        <script type="text/javascript">
                            function pharmacy_wise_doctors_contribution(){
                                let base_id   = parse_int($('#base_id').val());
                                let dRange  = $('#dRange').val();
                                $('#reportArea').html(loadingImage);
                                let request={pharmacy_wise_doctors_contribution:1,dRange:dRange,base_id:base_id}
                                localStorage.setItem('pharmacy_wise_doctors_contribution',JSON.stringify(request));
                                $.ajax({
                                    type:'post',
                                    url:ajUrl,
                                    data:request,
                            ...
                            $(document).ready(function(){
                                ...
                                pharmacy_wise_doctors_contribution();
                            });
                        </script>
                    </div>
                </div>
