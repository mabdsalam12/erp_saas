	...
	<div class="row">
		<div class="col-md-12">
			<div class="col-sm-12 col-md-12 col-lg-12" id="date_range">
                ...
                <div class="col-md-3">
                    <h5 class="box-title"> &nbsp;</h5>
                    <input class="form-check-input " type="checkbox" value="" id="withoutZero">
                    <label class="form-check-label" for="withoutZero">
                        Without Zero
                    </label>
                </div>
			...
			<script>
                $('#report-button').click(function(){income_statement();})
