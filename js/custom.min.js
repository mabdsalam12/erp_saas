$(document).ready(function() {
    ...
    $(function() {
        ...
        //l = $("ul.nav a").filter(function() {
        l = $("#side-menu.nav a").filter(function() {
            var currentModule=currentModuleFromUrl(this.href)
            return currentModule==CURRENT_MODULE
        }).addClass("active").parent().parent().addClass("in").parent();
...
function currentModuleFromUrl(url_string){
    var url = new URL(url_string);
    return url.searchParams.get(MODULE_URL);
}
function menuToggle(){
    $("body").hasClass("content-wrapper") ? ($("body").trigger("resize"), 
        ...
        $("body").addClass("content-wrapper"), $(".open-close i").removeClass("icon-arrow-left-circle"),
        $(".logo span").hide())
}