<?php
    ...
    $rData=[];
    $employee=$db->get_rowData('employees','id',$id);
    if(!empty($employee)){
        $hID=$acc->getEmployeeHead($employee,$jArray);
        ...
        $report_data=array(
            'name'      => 'employeesStat'.date('d/m/Y'),
            'title'     => 'Employees Statment',
            //'info'      => $reportInfo,
            'fileName'  => $fileName,
            'head'=>array(
                array('title'=>"#"              ,'key'=>'s'    ,'hw'=>5),
                array('title'=>"Employees Name" ,'key'=>'n'),
                array('title'=>"Head"           ,'key'=>'h'    ,'hw'=>15),
                array('title'=>"Date Time"      ,'key'=>'d'),
                array('title'=>"Particular"     ,'key'=>'p'),
                array('title'=>"User"           ,'key'=>'u'),
                array('title'=>"Debit"          ,'key'=>'in'   ,'al'=>'r'),
                array('title'=>"Credit"         ,'key'=>'out'  ,'al'=>'r'),
